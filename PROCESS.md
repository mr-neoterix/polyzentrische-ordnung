...
### V1 – Paragraphenzählung des Wohnungsgemeinnützigkeitsgesetzes
**Angelegt:** 21.08.2026, bei der Einarbeitung der Wohnungsgemeinnützigkeit in Kapitel 12.
**Gegenstand:** Das WGG vom 29.02.1940 wird mit vier Pflichten geführt – Entgelt nur zur Kostendeckung, Ausschüttung höchstens vier Prozent der eingezahlten Einlage, Vermögensbindung mit Bau- und Wiederanlagepflicht, beschränkter Geschäftskreis.
**Was fehlt:** die Paragraphen, in denen diese vier Pflichten stehen. Der Gesetzestext war aus zwei Arbeitsumgebungen nicht abrufbar (Ausgangsfilter; geprüft am 21.08.2026 für `recht.nrw.de` und `gesetze-im-internet.de`), und die im Netz auffindbaren Paragraphenverweise auf ein „WGG" betreffen überwiegend das österreichische Wohnungsgemeinnützigkeitsgesetz von 1979, das mit dem deutschen Gesetz von 1940 nicht identisch ist.
**Was ihn schließt:** Einsicht in den historischen Gesetzestext – Reichsgesetzblatt 1940, die aufgehobene Fassung in einer Landesrechtssammlung (etwa `recht.nrw.de`, Bestand „historisch") oder ein Kommentar zum WGG. Danach die Paragraphen in den Belegapparat von Kapitel 12 und in Abschnitt U von `quellen_und_glossar.md` nachtragen.
**Folge, falls offen:** keine für die Aussagen. Die vier Pflichten sind mehrfach unabhängig belegt; es fehlt allein die Zitierpräzision. Bis dahin gilt Regel vier: Paragraphen des WGG werden nicht genannt.
...
**Angelegt:** 20.08.2026, fortgeschrieben 21.08.2026.
**Gegenstand:** Der Belegapparat führt Netzadressen mit dem Vermerk „indiziert", nicht „abgerufen".
**Was fehlt:** die direkte Abrufprüfung. Von 183 geprüften Adressen ließen sich am 20.08.2026 nur die frei zugänglichen Rohdaten- und Veröffentlichungspfade dieses Bestands unmittelbar abrufen; eine Verzeichnisadresse in Abschnitt M wurde dabei berichtigt. Der Versuch vom 21.08.2026 aus derselben Umgebung bestätigt den Befund: `de.wikipedia.org`, `bundestag.de`, `gesetze-im-internet.de` und `recht.nrw.de` sind gesperrt.
**Was ihn schließt:** ein Durchlauf aus einer Umgebung ohne Ausgangsfilter, mit Berichtigung toter oder umgezogener Adressen und Umstellung des Vermerks von „indiziert" auf „abgerufen".
**Folge, falls offen:** eine unbequeme, aber ausgewiesene Position – Kapitel 26 Abschnitt V führt sie im Buch selbst. Für einen Text, dessen Kernargument die Nachprüfbarkeit ist, ist das der teuerste Eintrag dieses Verzeichnisses.
...
**Was ihn schließt:** Einsicht in die gedruckte Ausgabe, Bibliothek genügt.
