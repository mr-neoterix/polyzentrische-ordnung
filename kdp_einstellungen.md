...
Die Dateien kommen aus der jeweils jüngsten [Veröffentlichung](https://github.com/mr-neoterix/polyzentrische-ordnung/releases/latest); ihre Namen tragen die Ausgabenummer. Seitenzahl und Rückenbreite nennt der Text jeder Veröffentlichung. Ändert sich der Umfang eines Bandes, müssen Innenteil **und** Umschlag neu hochgeladen werden, denn der Rücken wächst mit. Die ISBN im Impressum trägt der Innenteil des ersten Bandes ab Ausgabe 3.5, der des zweiten ab Ausgabe 3.6; ältere Innenteile nicht mehr hochladen. Wer den ersten Band schon aus 3.5 hochgeladen hat, muss ihn nicht erneuern. **Die Überarbeitungen nach den Leserkritiken vom 24. und 25.09.2026 und das Register am Ende jedes Bandes ändern den Umfang beider Bände:** Am letzten Satzlauf vom 26.09.2026 gemessen hat der erste Band 194 statt 190 Seiten, der zweite 282 statt 240; darin ist berücksichtigt, dass die Belegapparate seit dem 25.09.2026 eine Schriftgröße kleiner stehen und seit dem 26.09.2026 nur noch Fundstelle, Status und Abgrenzung der Wertung führen, dass der erste Band seit dem 26.09.2026 am Ende von Kapitel 10 keinen Überblick über den zweiten mehr führt und dass sein zweites Kapitel seit demselben Tag die Zahlungsfähigkeit der DDR an ihren Anschlusskrediten misst, was zwei Seiten kostet. Der zweite trägt jetzt die offenen Flanken der Bauteile als eigenes Schlusskapitel, die Trennung von Methode, Daten und Rechnung bei der Datenstelle und die Staffel für den kleinen Betrieb; beide tragen die Einarbeitung der Kritik an der Einordnung des ersten Bandes und ein Register, das allein zwei und vier Seiten kostet. Daraus folgen auf weißem Papier ein Rücken von 11,1 und 16,1 mm und Druckkosten von 3,08 und 4,13 € bei Amazon.de, im Rechenbeispiel unten eine Tantieme von 4,21 und 4,27 € und ein Mindestlistenpreis von 6,16 und 8,27 €. Leseausgabe und Innenteil bleiben seitengleich. Die Tabellen dieser Datei führen noch Ausgabe 3.6; mit der ersten Veröffentlichung nach dieser Überarbeitung müssen für beide Bände Innenteil und Umschlag neu hochgeladen werden.
...
| Territorien | weltweite Rechte |
| Hauptmarktplatz | Amazon.de |
| Listenpreis | 3,99 € je Band, **mit** Mehrwertsteuer eingegeben |
| Tantieme | 70 %: Der Preis liegt zwischen 2,69 € und 12,99 € und mindestens 20 % unter dem Preis des Taschenbuchs |
| Zustellkosten | 0,12 € je MB der von KDP umgewandelten Datei, abgezogen vor der Tantieme |

*Rechnung:* In 3,99 € stecken 0,26 € Mehrwertsteuer. Von den übrigen 3,73 € gehen die Zustellkosten ab, bei den derzeit 0,3 bis 0,4 MB der EPUB-Dateien rund 4 Cent. Vom Rest bleiben bei 70 % rund 2,58 € je Verkauf. Welche Größe KDP nach der Umwandlung berechnet, zeigt die Preisseite nach dem Hochladen; bei einem vollen Megabyte blieben 2,53 €. Mit 35 % wären es 1,31 €.

**Preisangleichung:** Ist ein E-Book anderswo kostenlos erhältlich, darf Amazon es ebenfalls kostenlos anbieten, und die Tantieme ist dann null. Das EPUB liegt frei im Netz; das Kindle-E-Book kann also jederzeit kostenlos werden. Wer das nicht will, kann nur auf das E-Book bei Amazon verzichten. Mit der Buchpreisbindung gerät das nicht in Konflikt, solange das E-Book nicht unter sie fällt.

## Buchpreisbindung

Geprüft am 24.09.2026; das ist eine Einschätzung und keine Rechtsberatung. Maßgeblich ist das Buchpreisbindungsgesetz (BuchPrG), zuletzt geändert am 08.10.2023; für E-Books gilt es ausdrücklich seit dem 01.09.2016. Eine Gerichtsentscheidung zu selbstverlegten E-Books war nicht zu finden.

*Das Taschenbuch ist gebunden.* Ob ein Produkt „überwiegend verlags- oder buchhandelstypisch“ ist, fragt das Gesetz nur bei buchnahen Produkten wie E-Books (§ 2 Abs. 1 Nr. 3), bei gedruckten Büchern nicht. Wer im Selbstverlag veröffentlicht, ist Verleger nach § 5 Abs. 1 und muss für jede Ausgabe einen Endpreis mit Umsatzsteuer festsetzen und in geeigneter Weise veröffentlichen. Mancherorts ist zu lesen, KDP-Bücher ohne Eintrag im Verzeichnis lieferbarer Bücher (VLB) seien nicht gebunden; das gibt das Gesetz nicht her, denn die Pflicht entsteht mit dem Verlegen und nicht mit dem Eintrag. Für die Praxis heißt das:

- *Endpreis* ist der Ladenpreis auf Amazon.de, also der bei KDP eingegebene Listenpreis plus 7 %.
- *Veröffentlicht* wird er am Tag der Veröffentlichung in `README.md`. Üblich ist das VLB; wer dort nicht meldet, muss den Preis nach Auskunft des VLB auf anderem geeignetem Weg bekannt machen. Ob die Projektseite dafür genügt, ist nicht entschieden. Für einen Titel, den nur Amazon verkauft, ist sie vertretbar.
- *Eigene Exemplare,* etwa bei Lesungen, werden nur zum Endpreis verkauft (§ 3). Verschenken bleibt erlaubt, auch als Rezensionsexemplar: Das OLG Dresden hat 2018 die kostenlose Abgabe eines gebundenen Buches gegen bloße Versandkosten nicht als Verstoß gewertet (14 U 341/18).
- *Preisänderungen* sind jederzeit möglich. Sie gelten dann für alle Verkäufer und werden ebenso veröffentlicht. Nach 18 Monaten lässt sich die Bindung ganz aufheben (§ 8).

*Leseausgabe und EPUB im Netz sind nicht betroffen.* § 3 bindet nur den Verkauf, und die Pflicht zur Preisfestsetzung trifft nur Ausgaben, die zum Verkauf verlegt werden. Den Preis des Taschenbuchs unterlaufen die freien Dateien nicht, denn jede Ausgabe hat ihren eigenen Preis, ein E-Book einen anderen als das gedruckte Buch (BT-Drs. 18/8043, S. 9).

*Das Kindle-E-Book ist voraussichtlich nicht gebunden.* Die Gesetzesbegründung nimmt „von den Autoren selbst unter Nutzung spezialisierter Plattformen veröffentlichte elektronische Bücher“ ausdrücklich aus (BT-Drs. 18/8043, S. 8). Der Börsenverein liest das enger: Nach seinem Justiziar Christian Sprang haben Selbstverleger dieselben Pflichten wie Verlage, und ausgenommen ist ein E-Book, das nur ein einziger Händler anbietet. Nach beiden Lesarten ist das Kindle-E-Book ungebunden, solange zwei Bedingungen gelten:

1. **Nur KDP.** Kein weiterer E-Book-Shop, auch nicht kostenlos und auch nicht über einen Vertriebsdienst: weder Tolino noch Apple Books, Google Play oder andere. GitHub verkauft nicht und ist kein Händler.
2. **Keine ISBN.** Das E-Book bekommt keine eigene ISBN und keinen Eintrag im VLB; `isbn_ebook` in `satz/veroeffentlichung.toml` bleibt leer. Eine dort eingetragene ISBN schriebe das Satzskript auch in das freie EPUB, in Kennung und Impressum, und machte freie und bezahlte Fassung schon auf dem Papier zu derselben Ausgabe.

Dann ist der Preis von 3,99 € neben dem freien EPUB nach beiden Lesarten zulässig. Er liegt außerdem knapp unter einer Bagatellgrenze von rund 4 €, unter der E-Books nach Sprang ohnehin nicht gebunden seien. Im Gesetz steht diese Grenze nicht; sie ist ein Zusatzargument, das allein nichts trägt, und wer den Preis über 4 € hebt, verliert es.

*Fällt eine der beiden Bedingungen,* ist das E-Book wahrscheinlich gebunden, und dieselbe Ausgabe hätte zwei Preise: 3,99 € bei Amazon und null im Netz. Verschiedene Endpreise für einen Titel erlaubt § 5 Abs. 5 nur mit sachlichem Grund. Der oekom-Verlag etwa gestattet seinen Autoren neben einem bezahlten E-Book die freie Zweitveröffentlichung nur kapitelweise, weil das ganze E-Book der Preisbindung unterliege, und KDP verlangt dann bei jedem Händler denselben Listenpreis. Vor einem solchen Schritt ist die Frage neu zu stellen, am besten den Preisbindungstreuhändern der Verlage (Kanzlei Fuhrmann Wallenfels, Wiesbaden), die nach Auskunft des Börsenvereins auch zur Zulässigkeit beraten.

*Was ein Verstoß kostet:* Bußgelder kennt das Gesetz nicht. Buchhändler, Verbände und die Preisbindungstreuhänder können auf Unterlassung klagen, bei Verschulden auf Schadensersatz (§ 9), in der Praxis zuerst mit einer Abmahnung.

*Nicht geprüft* ist Österreich. Amazon.de liefert dorthin, und KDP führt Österreich für Taschenbuch und E-Book unter den Ländern mit Buchpreisbindung.
...
- Am Tag der Veröffentlichung die Ladenpreise beider Taschenbücher in `README.md` eintragen und jede spätere Preisänderung am selben Tag nachziehen. Für das E-Book ist das nicht verlangt.
...
Hilfeseiten von KDP, abgerufen am 24.09.2026: [Kategorien](https://kdp.amazon.com/en_US/help/topic/G200652170), [Schlüsselwörter](https://kdp.amazon.com/en_US/help/topic/G201298500), [Beschreibung](https://kdp.amazon.com/en_US/help/topic/G201189630), [Titel und Metadaten](https://kdp.amazon.com/en_US/help/topic/G201097560), [Inhaltsrichtlinien und KI](https://kdp.amazon.com/en_US/help/topic/G200672390), [Druckkosten](https://kdp.amazon.com/en_US/help/topic/G201834340), [Tantieme Taschenbuch](https://kdp.amazon.com/en_US/help/topic/G201834330), [Mehrwertsteuer bei Druckbüchern](https://kdp.amazon.com/en_US/help/topic/GPQL5W3J6WNRCZTV), [Tantieme E-Book](https://kdp.amazon.com/en_US/help/topic/G200644210), [Preisgrenzen E-Book](https://kdp.amazon.com/en_US/help/topic/G200634560), [Preisregeln E-Book](https://kdp.amazon.com/en_US/help/topic/G200634500), [DRM](https://kdp.amazon.com/en_US/help/topic/GDDXGH9VR22ACM8U), [Erweiterter Vertrieb](https://kdp.amazon.com/en_US/help/topic/GQTT4W3T5AYK7L45), [Druckoptionen](https://kdp.amazon.com/en_US/help/topic/G201834180). Die Kategorien stammen aus dem Kategoriebaum der Bestsellerlisten von Amazon.de, abgerufen am selben Tag. Die Zustellkosten von 0,12 € je MB nennt das Rechenbeispiel für Amazon.de auf der Seite zu den Preisregeln.

Zur Buchpreisbindung, abgerufen am 24.09.2026: [Buchpreisbindungsgesetz](https://www.gesetze-im-internet.de/buchprg/), [Gesetzesbegründung zu den E-Books, BT-Drs. 18/8043](https://dserver.bundestag.de/btd/18/080/1808043.pdf), [Christian Sprang zu Selbstverlegern bei literaturcafe.de](https://www.literaturcafe.de/preisbindung-fuer-self-publisher-ein-lesetipp-zum-leidigen-thema/), [OLG Dresden, 14 U 341/18](https://www.online-und-recht.de/urteile/abgabe-eines-preisgebundenen-buches-nicht-immer-verstoss-gegen-buchpreisbindung-oberlandesgericht-dresden-20180626/), [VLB zur Buchpreisbindung](https://vlb.de/hilfe/das-vlb-und-die-buchpreisbindung), [KDP: Buchpreis festlegen](https://kdp.amazon.com/de_DE/help/topic/G200641280), [oekom zu Open Access](https://www.oekom.de/service/open-access/c-311), [Börsenverein zur Buchpreisbindung](https://www.boersenverein.de/beratung-service/recht/buchpreisbindung/).

Zu ISBN und Impressum, abgerufen am 24.09.2026: [KDP: ISBN und Imprint](https://kdp.amazon.com/de_DE/help/topic/G201834170), [KDP: Angaben im Innenteil müssen mit dem Formular übereinstimmen](https://kdp.amazon.com/en_US/help/topic/G201834260), [Sächsisches Pressegesetz, § 6 Impressum](https://www.revosax.sachsen.de/vorschrift/4197-SaechsPresseG). Die Gliederung der ISBN folgt der Bereichstabelle der Internationalen ISBN-Agentur (Präfix 979-8, Verlagsnummern 1700000 bis 1799999 vierstellig).
