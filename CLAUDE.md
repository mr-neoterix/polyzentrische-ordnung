...
Begleitdateien: `quellen_und_glossar.md` (Quellenverzeichnis und Glossar; neue Begriffe und Belege dort eintragen, Verifikationsstatus ausweisen – Abschnitt G trägt die Anker des Manuskripts), `pruefbericht_schwachstellen.md` (adversariale Prüfung des Thesenpapiers, vollständig im Essay abgearbeitet, Nachweis in dessen Abschnitt G) `problemkatalog_polyzentrische_ordnung.md` (Stand 28.07.2026, 49 Einträge mit Lösungsvorschlägen; in Manuskript und Thesenpapier eingearbeitet, im Essay nicht) und `konzept_sorgegemeinschaft.md` (Stand 31.07.2026, Konstruktionsvorschlag zur Sorge-Flanke; **noch in kein Hauptdokument eingearbeitet** – wer ihn aufnimmt, tut es nach dessen Abschnitt X in Manuskript *und* Thesenpapier zugleich). Vor jeder Bearbeitung: das betroffene Hauptdokument vollständig lesen.
...
- **Sorgekonzept entscheiden.** `konzept_sorgegemeinschaft.md` (Stand 31.07.2026) entwickelt für die Sorge-Flanke eine Konstruktion: Sorgegemeinschaft als abstammungsblinde Rechtsform, gedecktes Sorgekonto als Eigenbeitragselement der Fondsfamilie, Umwidmung von Splitting und Erbschaftsteuerklassen statt neuem Fördertopf, fünf Sterblichkeitsregeln gegen die Dynastiegefahr, Kopplungsregel gegen den Infrastrukturrückzug. Das Papier ändert die Hauptdokumente nicht; sein Abschnitt X listet vollständig auf, was in Manuskript und Thesenpapier zu ändern wäre, wenn der Vorschlag angenommen wird – einschließlich einer Umnummerierung der Kapitel 16 bis 26, falls die Konstruktion ein eigenes Kapitel in Teil IV bekommt. Zu entscheiden ist zuerst, ob überhaupt eingearbeitet wird; erst danach lohnt die Arbeit.
