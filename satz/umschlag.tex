...
% microtype gleicht den Blocksatz des Umschlagtexts aus: Zeichen am Rand
% ragen ein wenig hinaus, und die Laufweite darf minimal atmen, damit die
% Wortabstände auf der schmalen Spalte nicht aufreißen.
...
% Der Umschlagtext steht im Blocksatz mit Silbentrennung, wie der Fließtext
% des Buches. Auf der Spalte von gut elf Zentimetern tragen die deutschen
% Komposita das nur mit etwas Notdehnung; ohne sie liefe eine Zeile über
% den Rand, statt dass ihre Wortabstände ein wenig wachsen.
\newcommand{\Blocksatz}{%
...
\ifnum\UDruck=1
  ...
  \sbox\UKlappe{\parbox[t]{\UTextbreite}{%
    \color{schrift}\fontsize{10.5pt}{14.6pt}\selectfont\Blocksatz
