...
Am Anfang stand eine Buchhaltungsfrage, und ihre Antwort lautete: Die DDR war nicht zahlungsunfähig gegenüber ihren Gläubigern, sondern gegenüber ihrer eigenen Zukunft. Sie verzehrte ihre Substanz, weil sie sich der beiden Geräte entledigt hatte, die Substanzverzehr sichtbar machen – Preise, die Knappheit melden, und Insolvenz, die falsche Entscheidungen aus der Welt schafft, ohne dass jemand sie eingestehen muss.

Warum sie sich ihrer entledigt hatte, zeigte die Reformgeschichte: Nicht der Plan als Technik war das Hindernis, sondern die Frage, wer plante und wofür. Jede Reform, die groß genug gewesen wäre, um zu wirken, hätte die Machtfrage gestellt – und wurde deshalb beendet.

Der Fallvergleich bestätigte das Muster und nannte seine Bestandteile. Ungarn lieferte den Begriff der weichen Budgetbeschränkung, der an keine Eigentumsform gebunden ist. Jugoslawien zeigte, dass Selbstverwaltung ohne Eigentum, ohne mitnehmbaren Anspruch, ohne Insolvenz und ohne offene Mitgliedschaft nicht trägt. Vietnam zeigte, dass Binnenreform vor Marktzugang wirkt. Kuba zeigte, dass wirtschaftliche Dynamik gekappt wird, sobald sie politisches Eigengewicht entwickelt. China zeigte, dass halbe Polyzentrik in monozentrischer Hülle spektakulär funktioniert und dann verfällt.
...
Es gibt keinen Endzustand, in dem das Machtproblem erledigt wäre. Es gibt nur die permanente Reparatur – und die eine Frage, ob eine Gesellschaft Institutionen besitzt, die ihr die Differenz zwischen dem, was sie ist, und dem, was sie sein könnte, sichtbar machen.

Jede Regel in diesem Buch wird angegriffen werden. Jede Kennzahl wird geschönt werden. Jede Sperre wird eines Tages mit dem Argument der Effizienz fallen. Das ist keine pessimistische Prognose, sondern die Anwendung des eigenen Befundes auf den eigenen Entwurf: Wer glaubt, seine Konstruktion sei von der Rost-These ausgenommen, hat sie nicht verstanden.

Deshalb steht am Ende dieses Buches nicht ein Versprechen, sondern ein Kriterium.

Fehlertoleranz ist das ehrlichste Maß einer guten Ordnung. Nicht, ob sie Fehler vermeidet – das kann keine –, sondern ob sie sie überlebt. Ob ihre Elemente scheitern können, ohne dass das Ganze scheitert. Ob aus dem Scheitern des Elements etwas gelernt wird, das ohne dieses Scheitern nicht zu erfahren gewesen wäre.
...
*Zu den Belegen: Jedes Kapitel schließt mit seinem eigenen Nachweisapparat samt Verifikationsstatus. Das vollständige Quellen- und Begriffsverzeichnis des Projekts liegt in `quellen_und_glossar.md`; die offenen Verifikationsaufträge sind im vierundzwanzigsten Kapitel ausgewiesen.*
